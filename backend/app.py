...
# definindo tags
home_tag = Tag(name="Documentação", description="Seleção de documentação: Swagge")
...
@app.post('/minimundo', tags=[smallword_tag],
...
@app.get('/minimundos', tags=[smallword_tag],
...
@app.get('/minimundo', tags=[smallword_tag],
...
@app.delete('/minimundo', tags=[smallword_tag],
...
@app.get('/busca_minimundo', tags=[smallword_tag],
         responses={"200": ListagemSmallwordsSchema, "404": ErrorSchema})
